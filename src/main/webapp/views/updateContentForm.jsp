    ...
    <section class="main">
        <div class="discription userhome-discription">
            <div class="heading-and-paragraph">
              ...
              <h2 class="subheading">Update Your Blog Post Here</h2>
          ...
          <form class="user-content-form" action="/updateContent/${content.id}" method="post">
          	<table class="user-update-whole-content" cellspacing="20px" cellpadding="20px">
          		<tr>
          			<td><label for="title">Title:</label></td>
          			<td><input type="text" value="${content.title}" name="title" required/></td>
          		</tr>
          		<tr>
          			<td><label for="content">Content:</label></td>
          			<td><textarea type="text" name="content" rows="7" cols="40" required>${content.content}</textarea></td>
          		</tr>
          		<tr>
          			<td><label for="author">Author Name:</label></td>
          			<td><input type="text" name="author" value="${content.author}" required/></td>
          		</tr>
          		<tr>
          			<td><label for="modify_date">Date:</label></td>
          			<td><input type="text" name="modify_date" value="${content.modify_date}" placeholder="yyyy-mm-dd" required/></td>
          		</tr>
          		<tr>
         			<td></td>
         			<td></td>
